...
const SLIDE_CLASSES =
  "flex-[0_0_50%] sm:flex-[0_0_30%] xl:flex-[0_0_15%] px-3 sm:px-4 py-12 flex flex-col items-center justify-center";
            ...
            <EmblaCarousel onSelect={onSelect}>
              {modulesList.map((module: ModuleItem) => (
                <div key={module.id} className={SLIDE_CLASSES}>
                  <div className="w-44 h-44 rounded-full bg-[#FF4C00] mb-4">
                    {/* <Image
                      fill
                      src={module.imageSrc}
                      alt={module.title}
