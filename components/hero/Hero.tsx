...
const BUTTON_SOLID_HERO_CLASSES =
  "inline-flex items-center justify-center px-3 py-2.5 sm:py-2 sm:px-8 text-sm sm:text-base lg:text-lg bold-fanum-font rounded-[50px] bg-[#FF4C00] text-white hover:bg-[#E64500]  w-full sm:w-44 cursor-pointer";

const BUTTON_OUTLINE_HERO_CLASSES =
  "inline-flex items-center justify-center px-3 py-2.5 sm:py-2 sm:px-8 text-sm sm:text-base lg:text-lg bold-fanum-font rounded-[50px] border-2 border-[#FF4C00] text-[#FF4C00] bg-transparent hover:bg-[#FF4C00]/10   w-full sm:w-auto cursor-pointer";
    ...
    <Container>
      ...
      >
        ...
        <div className="w-full xl:w-[35%] h-full   pt-4 sm:pt-5 md:pt-6 text-[#0A2745]">
          ...
          <p className="py-6 sm:py-8 md:py-8 lg:py-12 font-light -tracking-tighter lg:text-right text-center  text-base sm:text-lg xl:text-[16px] 2xl:text-[24px] fanum-font">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 py-2 regular-fanum-font lg:justify-start justify-center">
            <Link
              href="/price"
              type="button"
              className={BUTTON_SOLID_HERO_CLASSES}
            >
              دمو | مشاوره
            </Link>

            <Link href="/price" className={BUTTON_OUTLINE_HERO_CLASSES}>
              پلن ها | قیمت ها
            </Link>
          </div>
