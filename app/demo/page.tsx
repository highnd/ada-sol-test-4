...
export const contactData = [
  ...
  },
  {
    id: 4,
    title: "ساعت کاری",
    value: "شنبه تا چهارشنبه 9 تا 12",
    icon: FiMapPin,
  },
  {
    id: 5,
  ...
  return (
    <div>
      ...
      <div className="w-full min-h-56 lg:h-72 bg-accent flex items-center justify-center py-4 flex-col gap-4 px-4 text-center">
        ...
        <h2 className="text-secondary font-fanum text-lg max-w-4xl">
          برای دریافت جلسه دمو و مشاوره رایگان، اطلاعات خود را در فرم زیر ثبت
          کنید تا کارشناسان سول در کوتاه‌ترین زمان با شما تماس بگیرند.
        </h2>
      </div>
        ...
        <div className="w-full h-full flex flex-col xl:flex-row items-start gap-12">
          ...
          <div className="w-full  ">
            ...
            >
              ...
              {/* ایمیل */}
              <div className="flex flex-col gap-2">
                <label className="text-white text-sm text-right">ایمیل</label>
                <input
                  type="email"
              ...
              <div className="lg:col-span-2 flex flex-col gap-2">
                ...
                <textarea
                  ...
                  className={`${inputClass} rounded-xl min-h-25 resize-none`}
                  name="description"
...
export default DemoConsultingPage;
